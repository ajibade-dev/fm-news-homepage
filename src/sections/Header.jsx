...
const Header = () => {
 ...
 const handleNav = () => {
  ...
  return (
    <div class={nav ? "relative overlay-gray bg-white lg:pb-4 mx-auto" : "bg-white lg:pb-4 mx-auto"}>
  <div class="mx-auto max-w-[1240px] px-4 md:px-8">
    <header class="mx-auto flex items-center justify-between py-4 md:py-8">
      {/* <!-- logo - start --> */}
      ...
      <nav class=" hidden gap-12 lg:flex">
        <a href="#" className="text-base font-semibold text-dark-grayish-blue transition duration-100 hover:text-soft-red active:text-soft-red font-inter">Home</a>
        <a href="#" className="inline-flex items-center gap-1 text-base font-semibold text-dark-grayish-blue hover:text-soft-red font-inter">
          Features
        </a>
        <a href="#" className="text-base font-semibold text-dark-grayish-blue transition duration-100 hover:text-soft-red active:text-soft-red font-inter">Pricing</a>
        <a href="#" className="text-base text-dark-grayish-blue transition duration-100 hover:text-soft-red font-semibold active:text-soft-red font-inter">About</a>
      </nav>
      {/* <!-- nav - end --> */}

    {/* icon for menu open */}
      <div onClick={handleNav} className='cursor-pointer lg:hidden flex'>
      <svg width="25" height="17" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fill-rule="evenodd"><path d="M0 0h40v3H0zM0 7h40v3H0zM0 14h40v3H0z"/><path d="M0 0h40v3H0z"/></g></svg>
      </div>
    
    </header>
    <div className={nav ? ' fixed right-0 top-0 h-full w-[50%] z-10 bg-white transition ease-in-out duration-300 shadow-lg shadow-very-dark-blue pl-8' : ' fixed right-[-100%]'}>

        {/* icon for menu close */}
      <div className={nav ? 'fixed right-10 mt-8' : 'fixed right-[-100%]'} onClick={handleNav}>
    ...
    <ul className='pt-24'>
        <li className="text-base text-dark-grayish-blue transition duration-100 hover:text-soft-red font-semibold active:text-soft-red font-inter mb-5">
            Home
        </li>
        <li className="text-base text-dark-grayish-blue transition duration-100 hover:text-soft-red font-semibold active:text-soft-red font-inter mb-5">
            New
